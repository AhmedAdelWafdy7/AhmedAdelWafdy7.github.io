 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,A){var F=P.length;P.push(A);e:for(;0<F;){var W=F-1>>>1,O=P[W];if(0<i(O,A))P[W]=A,P[F]=O,F=W;else break e}}function r(P){return P.length===0?null:P[0]}function n(P){if(P.length===0)return null;var A=P[0],F=P.pop();if(F!==A){P[0]=F;e:for(var W=0,O=P.length,Q=O>>>1;W<Q;){var Y=2*(W+1)-1,ge=P[Y],Ee=Y+1,Z=P[Ee];if(0>i(ge,F))Ee<O&&0>i(Z,ge)?(P[W]=Z,P[Ee]=F,W=Ee):(P[W]=ge,P[Y]=F,W=Y);else if(Ee<O&&0>i(Z,F))P[W]=Z,P[Ee]=F,W=Ee;else break e}}return A}function i(P,A){var F=P.sortIndex-A.sortIndex;return F!==0?F:P.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var l=[],c=[],u=1,f=null,g=3,p=!1,w=!1,v=!1,b=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(P){for(var A=r(c);A!==null;){if(A.callback===null)n(c);else if(A.startTime<=P)n(c),A.sortIndex=A.expirationTime,t(l,A);else break;A=r(c)}}function k(P){if(v=!1,y(P),!w)if(r(l)!==null)w=!0,B(C);else{var A=r(c);A!==null&&$(k,A.startTime-P)}}function C(P,A){w=!1,v&&(v=!1,m(R),R=-1),p=!0;var F=g;try{for(y(A),f=r(l);f!==null&&(!(f.expirationTime>A)||P&&!D());){var W=f.callback;if(typeof W=="function"){f.callback=null,g=f.priorityLevel;var O=W(f.expirationTime<=A);A=e.unstable_now(),typeof O=="function"?f.callback=O:f===r(l)&&n(l),y(A)}else n(l);f=r(l)}if(f!==null)var Q=!0;else{var Y=r(c);Y!==null&&$(k,Y.startTime-A),Q=!1}return Q}finally{f=null,g=F,p=!1}}var S=!1,T=null,R=-1,z=5,M=-1;function D(){return!(e.unstable_now()-M<z)}function L(){if(T!==null){var P=e.unstable_now();M=P;var A=!0;try{A=T(!0,P)}finally{A?G():(S=!1,T=null)}}else S=!1}var G;if(typeof h=="function")G=function(){h(L)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,K=j.port2;j.port1.onmessage=L,G=function(){K.postMessage(null)}}else G=function(){b(L,0)};function B(P){T=P,S||(S=!0,G())}function $(P,A){R=b(function(){P(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){w||p||(w=!0,B(C))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return r(l)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var A=3;break;default:A=g}var F=g;g=A;try{return P()}finally{g=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,A){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var F=g;g=P;try{return A()}finally{g=F}},e.unstable_scheduleCallback=function(P,A,F){var W=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?W+F:W):F=W,P){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=F+O,P={id:u++,callback:A,priorityLevel:P,startTime:F,expirationTime:O,sortIndex:-1},F>W?(P.sortIndex=F,t(c,P),r(l)===null&&P===r(c)&&(v?(m(R),R=-1):v=!0,$(k,F-W))):(P.sortIndex=O,t(l,P),w||p||(w=!0,B(C))),P},e.unstable_shouldYield=D,e.unstable_wrapCallback=function(P){var A=g;return function(){var F=g;g=A;try{return P.apply(this,arguments)}finally{g=F}}}})(Xp);Yp.exports=Xp;var v0=Yp.exports;/**
 * @license React
...
`,readTime:"7 min read",slug:"week-14"},L5={week:15,title:"Week 15: Flutter UI Development & Midterm Demonstration - Rich Metadata Visualization",date:"August 2025",author:"Ahmed Adel Wafdy",tags:["GSoC 2025","Toyota Connected","IVI","Homescreen","Flutter","UI/UX","Demo","AppStream","Figma","Categories"],published:!0,excerpt:"This week focused on comprehensive Flutter UI development and creating a compelling midterm demonstration video. The semi-functional interface showcases rich application metadata visualization, intuitive category browsing, and detailed application views based on professional design patterns.",content:`
   `,readTime:"7 min read",slug:"week-15"},O5={week:16,title:"Week 16: Flutter UI Development & Midterm Demonstration - Rich Metadata Visualization",date:"August 2025",author:"Ahmed Adel Wafdy",tags:["GSoC 2025","Toyota Connected","IVI","Homescreen","Flutter","UI/UX","Demo","AppStream","Figma","Categories"],published:!0,excerpt:"This week focused on comprehensive Flutter UI development and creating a compelling midterm demonstration video. The semi-functional interface showcases rich application metadata visualization, intuitive category browsing, and detailed application views based on professional design patterns.",content:`
    
`,readTime:"7 min read",slug:"week-16"},D5={week:17,title:"Week 17: Flutter UI Development & Midterm Demonstration - Rich Metadata Visualization",date:"August 2025",author:"Ahmed Adel Wafdy",tags:["GSoC 2025","Toyota Connected","IVI","Homescreen","Flutter","UI/UX","Demo","AppStream","Figma","Categories"],published:!0,excerpt:"This week focused on comprehensive Flutter UI development and creating a compelling midterm demonstration video. The semi-functional interface showcases rich application metadata visualization, intuitive category browsing, and detailed application views based on professional design patterns.",content:`
    
`,readTime:"7 min read",slug:"week-17"},B5={week:18,title:"Week 18: Optimizing Application Launching with XDG Desktop Portals and Enhancing User Experience",date:"October 2025",author:"Ahmed Adel Wafdy",tags:["GSoC 2025","Toyota Connected","IVI","Homescreen","Flutter","UI/UX","C++","D-Bus","Figma","Portals"],published:!0,excerpt:"This week focused on optimizing application launching using XDG Desktop Portals and enhancing user experience through improved UI/UX design, including a plan to refactor D-Bus handling and permissions.",content:`
    <div style="background: linear-gradient(135deg, rgba(34, 197, 94, 0.1), rgba(59, 130, 246, 0.1)); border: 1px solid rgba(34, 197, 94, 0.3); border-radius: 12px; padding: 20px; margin: 24px 0;">
      <h3 style="margin-top: 0; color: rgb(34, 197, 94); display: flex; align-items: center; gap: 8px;">
        <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
          <path d="M5 3.254V3.25v.005a.75.75 0 110-.005v.004zm.787 1.44c.18-.14.403-.25.663-.25.138 0 .27.027.393.077.364.148.594.52.594.923 0 .608-.481 1.101-1.125 1.101-.645 0-1.125-.493-1.125-1.101 0-.403.23-.775.594-.923.123-.05.255-.077.393-.077.26 0 .483.11.663.25zm2.176 0c.18-.14.403-.25.663-.25.138 0 .27.027.393.077.364.148.594.52.594.923 0 .608-.481 1.101-1.125 1.101-.645 0-1.125-.493-1.125-1.101 0-.403.23-.775.594-.923.123-.05.255-.077.393-.077.26 0 .483.11.663.25zM8 1C3.58 1 0 4.58 0 9c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 9c0-4.42-3.58-8-8-8z"></path>
