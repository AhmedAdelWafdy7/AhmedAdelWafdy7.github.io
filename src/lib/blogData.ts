...
ostree --repo=/opt/flat-manager/stable-repo fsck</code></pre>
  ...
  },
  {
    ...
    published: true,
    excerpt: "Extending Flatpak Plugin API: Implementation Architecture and Sandboxing Deep Dive",
    content: `
    <h2>Introduction</h2>
  ...
  },
  {
    ...
    content: "<p>This post for Week 6 is coming soon! Stay tuned for updates on Flutter implementation.</p>",
    readTime: "7 min read",
    slug: "week-6"
  }
];
